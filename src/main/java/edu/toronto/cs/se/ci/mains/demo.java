...
public class demo {
	...
	//static private String outFilePath = "./data/chillwall-versus-random-english-0.5.arff";
	static private String outFilePath = "./data/chillwall-versus-scramble-0.6.arff";
